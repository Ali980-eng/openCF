...
#define OPENCF___CFRONT___OBJECT_DATA_H
     ...
     */
         ...
         */
        #define ocf_bool(name, val) const _Bool name DATA_SEC = val;
         ...
         */
        #define ocf_char(name, val) const char name DATA_SEC = val;
         ...
         */
        #define ocf_short(name, val) const short name DATA_SEC = val;
         ...
         * @param val int value.
         */
        #define ocf_int(name, val) const int name DATA_SEC = val;
         ...
         */
        #define ocf_float(name, val) const float name DATA_SEC = val;
         ...
         */
        #define ocf_double(name, val) const double name DATA_SEC = val;
         ...
         */
        #define ocf_long(name, val) const long name DATA_SEC = val;
         ...
         */
        #define ocf_int8(name, val) const int8_t name DATA_SEC = val;
         ...
         */
        #define ocf_int16(name, val) const int16_t name DATA_SEC = val;
         ...
         */
        #define ocf_int32(name, val) const int32_t name DATA_SEC = val;
         ...
         */
        #define ocf_uint8(name, val) const uint8_t name DATA_SEC = val;
         ...
         */
        #define ocf_uint16(name, val) const uint16_t name DATA_SEC = val;
         ...
         */
        #define ocf_uint32(name, val) const uint32_t name DATA_SEC = val;
         ...
         */
        #define ocf_string(name, val) const char name[] DATA_SEC = val;
             ...
             */
            #define ocxxf_string(name, val) const std::string name DATA_SEC = val;
             ...
             */
            #define ocxxf_vector(name, type, ...) const std::vector<type> name DATA_SEC = {__VA_ARGS__};
             ...
             */
            #define ocxxf_map(name, key_type, value_type, ...) const std::map<key_type, value_type> name DATA_SEC = {__VA_ARGS__};

            /**
             * @def ocxxf_unordered_map
             ...
             * @param ... initializer entries.
             */
            #define ocxxf_unordered_map(name, key_type, value_type, ...) const std::unordered_map<key_type, value_type> name DATA_SEC = {__VA_ARGS__};
             ...
             */
            #define ocxxf_queue(name, type) const std::queue<type> name DATA_SEC = std::queue<type>();
             ...
             */
            #define ocxxf_function(name, signature, func_obj) const std::function<signature> name DATA_SEC = func_obj;
             ...
             */
            #define ocxxf_data(name, type, val) const type name DATA_SEC = val;
         ...
         * @param val initializer value.
         */
        #define ocf_auto(name, val) const auto name = val;
         ...
         * @param val initializer value.
         */
        #define ocf_dynamic(name, val) const __typeof__(val) name = val;
             ...
             */
            #define ocf_int64(name, val) const int64_t name __attribute__((aligned(8))) = val;
             ...
             */
            #define ocf_uint64(name, val) const uint64_t name __attribute__((aligned(8))) = val;
         ...
         * @param ... initializer values.
         */
        #define ocf_array_i32(name, ...) const int32_t name[] = {__VA_ARGS__};
         ...
         * @param ... initializer values.
         */
        #define ocf_array_f64(name, ...) const double name[] = {__VA_ARGS__};
