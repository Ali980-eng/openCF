...
#ifndef METACORE___CGEN___DDT_ARRAY_H
#define METACORE___CGEN___DDT_ARRAY_H
 ...
 */
static inline bool contains(carray *arr, cdynamic dvalue) { return find(arr, dvalue.value) != -1; }
...
#endif // METACORE___CGEN___DDT_ARRAY_H