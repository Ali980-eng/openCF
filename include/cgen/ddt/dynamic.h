 ...
 */
static inline const char* type_name(cdynamic self)
{
    switch (self.id)
    {
    case dyn_enum_null:
 ...
 */
static inline cdynamic convert_to(cdynamic self, uint8_t target_type)
{
    switch (target_type)
    {
    case dyn_enum_null:
 ...
 */
static inline uint8_t get_id(cdynamic self) { return self.id; }

static inline bool is_null(cdynamic self) { return self.id == dyn_enum_null; }

static inline bool is_bool(cdynamic self) { return self.id == dyn_enum_bool; }

static inline bool is_char(cdynamic self) { return self.id == dyn_enum_char; }

static inline bool is_short(cdynamic self) { return self.id == dyn_enum_short; }

static inline bool is_int(cdynamic self) { return self.id == dyn_enum_int; }

static inline bool is_long(cdynamic self) { return self.id == dyn_enum_long; }

static inline bool is_float(cdynamic self) { return self.id == dyn_enum_float; }

static inline bool is_double(cdynamic self) { return self.id == dyn_enum_double; }
